    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            <div class="w-full flex flex-col mb-6">
                <label for="name" class="pb-2 font-semibold text-gray-800">Skill Name</label>
                <InputText type="text"
                           id="name"
                           v-model="form.name"
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="section" class="pb-2 font-semibold text-gray-800">Section</label>
                <Dropdown id="section" v-model="form.section_id" :options="sections" :filter="true" optionLabel="name" optionValue="id" dataKey="id" placeholder="Select a Section" />
