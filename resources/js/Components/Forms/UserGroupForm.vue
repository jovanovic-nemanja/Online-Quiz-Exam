    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="name" class="pb-2 font-semibold text-gray-800">User Group Name<span class="ml-1 text-red-400">*</span></label>
                <InputText type="text" id="name" v-model="form.name" placeholder="Enter Category Name" aria-describedby="name-help"
            ...
            <!-- Description -->
            <div class="w-full flex flex-col mb-6">
                <label for="name" class="pb-2 font-semibold text-gray-800">Description (Max. 1000 Characters)</label>
            ...
            <div class="w-full">
                ...
                <div class="flex justify-between items-center mb-8">
                    <div class="w-9/12">
                        <label for="is_private" class="font-semibold text-gray-800 pb-1" v-html="form.is_private ? 'Private Group' : 'Public Group'"></label>
                        <p class="text-gray-500">Private Group (Only admin can add users). Public Group (Anyone can join)</p>
                    </div>
                    <div class="cursor-pointer rounded-full relative shadow-sm">
