                            ...
                            <div class="card-body flex flex-col justify-center h-96">
                                <table class="w-full table-auto">
                                    ...
                                    <tr class="bg-emerald-200">
                                        <td class="border border-emerald-500 px-4 py-2 text-emerald-600 font-medium text-sm">Status</td>
                                        <td class="border border-emerald-500 px-4 py-2 text-emerald-600 text-sm">{{ session.status }}</td>
                                    </tr>
                                    <tr class="bg-emerald-200">
                                        <td class="border border-emerald-500 px-4 py-2 text-emerald-600 font-medium text-sm">Completed on</td>
