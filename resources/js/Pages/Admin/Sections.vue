<template>
    <admin-layout>
        <template #header>
            <h4 class="page-heading">Sections</h4>
        </template>
        <template #actions>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <Sidebar position="right" :visible.sync="createForm" v-on:hide="loadItems" class="p-sidebar-md">
                        <SectionForm :errors="errors" @close="createForm = false;" title="New Section"/>
                    </Sidebar>
                    <Sidebar position="right" :visible.sync="editForm" v-on:hide="loadItems" class="p-sidebar-md">
                        <SectionForm :edit-flag.sync="editForm" :section-id="currentId" :errors="errors"
                                      @close="editForm = false;" title="Edit Section"/>
                    </Sidebar>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            title() {
                return 'Sections - ' + this.$page.props.general.app_name + ' Admin';
            }
        },
        methods: {
