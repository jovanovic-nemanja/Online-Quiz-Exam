    ...
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            <div class="w-full flex flex-col mb-6">
                <label for="name" class="pb-2 font-semibold text-gray-800">Topic Name</label>
                <InputText type="text"
                           id="name"
                           v-model="form.name"
                           placeholder="Enter Topic Name" aria-describedby="name-help"
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="skill" class="pb-2 font-semibold text-gray-800">Skill</label>
                <Dropdown id="skill" v-model="form.skill_id" :options="skills" :filter="true" optionLabel="name" optionValue="id" dataKey="id" placeholder="Select a Skill" />
                <small id="skill-help" v-if="errors.skill_id" class="p-invalid">{{ errors.skill_id }}</small>
            </div>
            <div class="w-full flex flex-col mb-6">
                <label for="short_description" class="pb-2 font-semibold text-gray-800">Short Description</label>
